...
=================================================
 ...
 [9]  Device Information & Rename PC             
...
### Feature Highlights:
- **`[0] ⚡ RUN COMPLETE PROVISIONING BUNDLE`:** Single-click sequential execution of all software installers, printer drivers, Defender exclusions, performance tweaks, and automated audit report generation in minutes.
...
- **`[7] Gprinter Thermal Label Driver`:** Seagull Scientific driver package for TSC/TSPL label & barcode printing with automated PnP staging and Driver Wizard assistance.
...
- **`[9] Device Info & Rename`:** Detailed hardware and network inspection with one-click computer renaming.
